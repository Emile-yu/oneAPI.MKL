// mkl.cpp.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
    OneMKLFactory factory;
    const OperationBase* operation = factory.GetInstance(MklType_t::MatrixMul);
    ...
    for (i = 1; i <= max_threads; ++i)
    {
        ...
        printf("Matrix multiplication using dgemm completed \n"
            " at %.5f microseconds using %d threads \n\n",
            (s_elapsed * 1000 * 1000), i);
